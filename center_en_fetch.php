...
<body>
    ...
    <form method="post" action="center_en_status.php">
        <div class="container">
            <table>
                <tr>
                    <th>ID</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $id = $row["t_Center_id"];
                        $c_name = $row["t_Center_name"];
                        $location = $row["t_Location"];
                        $cont_person = $row["t_Contact_person_nm"];
                        $email = $row["t_Contact_email"];
                        $contact = $row["t_Contact_number"];
                        $c_image = htmlspecialchars($row["t_center_img"]);
                        $status = $row["status"];
                        ...
                        echo "<td>$c_name</td>";
                        echo "<td>$location</td>";
                        echo "<td>$cont_person</td>";
                        echo "<td>$email</td>";
                        echo "<td>$contact</td>";
                        echo "<td><img src='$c_image' alt='Event Image' style='max-width: 150px; max-height: 150px;'></td>";
