...
<?php include "a_dashb.php"; // Include the dashboard content ?>
    <!-- <h1>Center Status</h1> -->
    <br>
    <form method="post" action="course_status.php">
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $tr_nm = $row["instructor"];
                    $start_date = $row["start_date"];              
                    $course_image = htmlspecialchars($row["image1"]);
                    ...
                    echo "<td><img src='$course_image' alt='Event Image' style='max-width: 150px; max-height: 150px;'></td>";
                    echo "<td>$location</td>";
