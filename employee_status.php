...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["status"])) {
    ...
    echo "<script>alert('Changes saved successfully');window.location.href='employe_fetch.php';</script>";
    
} else {
    echo "<script>alert('All entries disabled. Changes saved successfully');window.location.href='employe_fetch.php';</script>";
