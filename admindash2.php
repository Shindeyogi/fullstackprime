...
<body>
    ...
    <div class="sidebar">
    <a href="admindash2.php" class="dashboard-link">
        <h2>Dashboard</h2>
    </a>
        ...
        <div class="dropdown">
            <a href="hm_enq_fetch.php" class="dropdown">
                <i class="fas fa-address-book"></i>Enquiry
            </a>
    ...
    <div class="dropdown">
        <a href="#" class="dropdown-toggle">
            <i class="fas fa-laptop icon"></i>Developers Team
        </a>
            <div class="dropdown-menu">
                <a href="add_devloper_team.php">Add Developer</a>
                <a href="devlop_team_en.php">View Developer</a>
            </div>
        </div>

        <div class="dropdown">
    <a href="#" class="dropdown-toggle">
        <i class="fas fa-laptop icon"></i> Slider Image
    </a>
    <div class="dropdown-menu">
        <a href="sliderimg.php">Add Image</a>
        <a href="sliderimg_en.php">View Image</a>
    </div>
</div>
    </div>
    </div>
