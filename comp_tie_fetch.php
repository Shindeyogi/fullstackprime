...
<body>
    ...
    <form method="post" action="com_tie_status.php">
        <div class="container">
            <table>
                <tr>
                    <th>ID</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $com_website = $row["website"];
                        $com_logo = htmlspecialchars($row["company_logo"]);
                        $status = $row["status"];
                        ...
                        echo "<td>$com_name</td>";
                        echo "<td>$location</td>";
                        echo "<td>$com_website</td>";
                        echo "<td><img src='$com_logo' alt='Event Image' style='max-width: 150px; max-height: 150px;'></td>";
