...
<body>
    ...
    <form method="post" action="devlop_en_status.php">
        <div class="container">
            <table>
                <tr>
                    <th>ID</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><img src='$image' alt='devloper Image' style='max-width: 150px; max-height: 150px;'></td>";
