...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["status"])) {
    ...
    echo "<script>alert('Changes saved successfully');window.location.href='event_en_fetch.php';</script>";
    ...
    echo "<script>alert('All entries disabled. Changes saved successfully');window.location.href='event_en_fetch.php';</script>";
}
